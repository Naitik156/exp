...
const App = () => {
    ...
    const [data, setData] = useState(() => {
        // LocalStorage se purana data uthana
        const saved = localStorage.getItem('syllabusData');
        
        // Naya structure: Isme humne 'performanceHistory: {}' jora hai
        const defaultData = { 
            NEET: {}, 
            JEE: {}, 
            dailyGoals: [], 
            performanceHistory: {} // Yeh pichle dino ka progress save karega
        };
        ...
        if (saved) {
            ...
            return { 
                ...defaultData, 
                ...parsedData,
                // Agar purane data mein history nahi hai, toh khali object {} laga do
